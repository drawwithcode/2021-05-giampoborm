...
function preload() {
  myImage = loadImage("./assets/trolley.png");
...
function setup() {
  ...
  myButton = createElement("button", "next meme");
  myButton.position(width-100, height-100);
  myButton.mouseClicked(function () {
    window.open(url + "second-page.html", "_self");
  });
  
  imageMode(CENTER)
  image(myImage, width/2, height/2, image.width, image.height);
